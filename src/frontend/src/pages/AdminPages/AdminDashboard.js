...
import '../Dashboard.css'; // Osiguraj da je putanja točna
import './AdminPages.css';

// Ikone (SVG komponente za čišći kod)
  ...
  const fetchStats = async () => {
    try {
      ...
      const headers = {
        ...
        'Authorization': `Bearer ${token}` // Dodana autorizacija
      };

      // Paralelni fetch za brže učitavanje
      ...
      // Sigurnosna provjera da je usersData array (ako backend vrati objekt greške)
      ...
      setStats({
        users: {
          ...
          pending: usersData.filter(u => !u.approved).length, // Ili provjeri subscriptionStatus ako to koristiš
        },
        competitions: {
    ...
    <div className="dashboard-wrapper">
      <div className="dashboard-container">
        ...
        <div className="actions-grid">
          ...
          <Link to="/admin/članarine" className="action-card highlight">
            <div className="action-card-header">
              <CreditCardIcon />
              <h3>Članarine</h3>
            </div>
